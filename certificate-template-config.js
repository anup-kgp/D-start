...
export const CERT_TEMPLATES = {
  men10: {
    ...
    ranked: {
      ...
      "2": { file: "./assets/certificates/men-10km-rank-2.png", name: NAME_SLOT, reg: REG_SLOT },
      "3": { file: "./assets/certificates/men-10km-rank-3.png", name: NAME_SLOT, reg: REG_SLOT },
      "4": { file: "./assets/certificates/men-10km-rank-4.png", name: NAME_SLOT, reg: REG_SLOT },
      "5": { file: "./assets/certificates/men-10km-rank-5.png", name: NAME_SLOT, reg: REG_SLOT },
    },
  },
  women5: {
    finisher: {
    ...
    ranked: {
      "1": { file: "./assets/certificates/women-5km-rank-1.png", name: WOMEN_NAME_SLOT, reg: REG_SLOT },
      // Rank 2/4/5: name a little up.
      "2": { file: "./assets/certificates/women-5km-rank-2.png", name: { ...WOMEN_NAME_SLOT, yPct: 44.5 }, reg: REG_SLOT },
      "3": { file: "./assets/certificates/women-5km-rank-3.png", name: WOMEN_NAME_SLOT, reg: REG_SLOT },
      "4": { file: "./assets/certificates/women-5km-rank-4.png", name: { ...WOMEN_NAME_SLOT, yPct: 44.5 }, reg: REG_SLOT },
      "5": { file: "./assets/certificates/women-5km-rank-5.png", name: { ...WOMEN_NAME_SLOT, yPct: 44.5 }, reg: REG_SLOT },
    },
  },
};
